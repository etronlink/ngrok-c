...
int ConnectMain(int *mainsock,struct sockaddr_in server_addr,ssl_info **mainsslinfo,string *ClientId,map<int,sockinfo*>*socklist,char *authtoken, string *Account, string *DevID, string *DevType, string *Osversion);
#endif
